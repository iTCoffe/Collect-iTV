...
def generate_output_files(valid_urls, cctv_channels, province_channels, m3u_filename, txt_filename):
    ...
    with open(m3u_filename, 'w', encoding='utf-8') as f:
        # 添加带有所需属性的标题行
        f.write("#EXTM3U x-tvg-url=\"https://itv.sspai.dpdns.org/epg.xml\" catchup=\"append\" catchup-source=\"?playseek=${(b)yyyyMMddHHmmss}-${(e)yyyyMMddHHmmss}\"\n")
...
if __name__ == "__main__":
    ...
    file_urls = [
        ...
        "https://raw.githubusercontent.com/0610840119/iptv-api/master/output/xp_result.m3u"
        "https://raw.githubusercontent.com/8080713/iptv-api666/main/output/result.m3u"
    ]
