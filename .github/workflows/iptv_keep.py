...
def generate_output_files(valid_urls, cctv_channels, province_channels, m3u_filename, txt_filename):
    ...
    with open(m3u_filename, 'w', encoding='utf-8') as f:
        # 添加带有所需属性的标题行
        f.write("#EXTM3U x-tvg-url=\"https://itv.jsdelivr.dpdns.org/epg.xml\" catchup=\"append\" catchup-source=\"?playseek=${(b)yyyyMMddHHmmss}-${(e)yyyyMMddHHmmss}\"\n")

        # 添加新的 EXTINF 行
        f.write("#EXTINF:-1 tvg-id=\"温馨提示\" tvg-name=\"温馨提示\" tvg-logo=\"https://logo.5iclub.dpdns.org/tv/温馨提示.png\" group-title=\"🦧温馨提示\",温馨提示\n")
...
if __name__ == "__main__":
    ...
    file_urls = [
        "https://raw.githubusercontent.com/mytv-android/mytvJS/main/js.gitee.m3u"
    ]
